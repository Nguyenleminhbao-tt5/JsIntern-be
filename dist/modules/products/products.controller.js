...
let ProductsController = class ProductsController {
    ...
    async createProduct(newProduct) {
        try {
            newProduct = product_dto_1.ProductDto.plainToClass(newProduct);
    ...
    async updateProduct(product_id, editProduct) {
        try {
            const response = await this.productsService.updateProduct(product_id, editProduct);
            return response;
        }
        catch (err) {
            throw err;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductsController.prototype, "showProduct", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
